  ...
  return (
    <main className="flex-1 bg-zinc-950 text-zinc-50">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        <h1 className="text-3xl font-black text-white sm:text-4xl mb-8">Terms of Service</h1>
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">5. Data Accuracy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">6. Third-Party Links and Content</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have questions about these Terms of Service, please contact us at <Link href="/" className="text-blue-400 hover:underline">our homepage</Link>.
            </p>
          </section>
        </div>
      </div>
