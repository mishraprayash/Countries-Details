  ...
  return (
    <main className="flex-1 bg-atlas-950 text-text-primary">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        <h1 className="text-3xl font-black text-text-primary sm:text-4xl mb-8 font-instrument-serif">Disclaimer</h1>
        ...
        <div className="space-y-8 text-text-secondary leading-relaxed font-sora">
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">1. General Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">2. Data Sources</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">3. Not Professional Advice</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">4. External Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">5. Affiliate Disclosure</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">6. Changes to This Disclaimer</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Disclaimer, please contact us at <Link href="/" className="text-cyan-glow hover:underline">our homepage</Link>.
            </p>
          </section>
        </div>
      </div>
