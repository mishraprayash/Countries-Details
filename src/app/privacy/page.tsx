  ...
  return (
    <main className="flex-1 bg-atlas-950 text-text-primary">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        <h1 className="text-3xl font-black text-text-primary sm:text-4xl mb-8 font-instrument-serif">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-text-secondary leading-relaxed font-sora">
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">2. Information We Collect</h2>
            <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2 font-instrument-serif">Information You Provide</h3>
            ...
            <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2 font-instrument-serif">Automatically Collected Information</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">3. Local Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">4. Cookies and Tracking Technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">5. Third-Party Advertising</h2>
            <p>
            ...
            <p className="mt-2">
              Google&apos;s use of advertising cookies enables it and its partners to serve ads based on your visit to our Service and other sites on the Internet. You may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-cyan-glow hover:underline">Google Ads Settings</a>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">6. Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">7. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">8. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">9. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">10. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">11. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3 font-instrument-serif">12. Contact Us</h2>
            <p>
              If you have questions or concerns about this Privacy Policy, please contact us at <Link href="/" className="text-cyan-glow hover:underline">our homepage</Link>.
            </p>
          </section>
        </div>
      </div>
