...
export default function AboutPage() {
  return (
    <main className="flex-1 bg-zinc-950 text-zinc-50">
      {/* Hero */}
      <div className="relative overflow-hidden border-b border-white/5 bg-zinc-900/50">
        <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-blue-500/10 blur-3xl" />
        <div className="absolute -bottom-20 left-0 h-64 w-64 rounded-full bg-indigo-500/10 blur-3xl" />
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-500/10 ring-1 ring-blue-500/20">
            <Globe className="h-8 w-8 text-blue-400" />
          </div>
          <h1 className="text-3xl font-black text-white sm:text-5xl">About World Insights</h1>
          <p className="mt-4 text-lg text-zinc-400 sm:text-xl leading-relaxed">
        ...
        <div className="space-y-12 text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="grid gap-4 sm:grid-cols-2 mt-6">
              {[
                ...
                return (
                  <div key={item.title} className="rounded-xl border border-white/5 bg-zinc-900/50 p-5">
          ...
          <section>
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1 text-zinc-400">
              <li><a href="https://restcountries.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">REST Countries API</a> — Country data, flags, capitals, and demographics</li>
              <li><a href="https://data.worldbank.org" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">World Bank Open Data</a> — GDP, literacy rates, and life expectancy</li>
              <li><a href="https://en.wikipedia.org" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Wikipedia API</a> — Country of the Day facts and summaries</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Support Us</h2>
            <p>
          ...
          <section>
            ...
            <p>
              Have a question, suggestion, or found a bug? We&apos;d love to hear from you. Reach out to us at <Link href="/" className="text-blue-400 hover:underline">our homepage</Link> or find us on <a href="https://github.com/mishraprayash/Countries-Details" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">GitHub</a>.
            </p>
          </section>
        </div>
      </div>
